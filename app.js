...
app.post('^/register(.html)?$', (req, res) => {
  ...
  const user = req.body;
  // console.log( user );
  const result = users.find(data => data.userId === user.userId && data.userEmail === user.userEmail);
  console.log(result);
...
app.post('^/login(.html)?$', (req, res) => {
  ...
  const result = users.find(data => data.userId === userId && data.userPwd === userPwd);
  console.log(result);
